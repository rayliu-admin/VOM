...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='../checkpoints/mgrwp.pth',
                        help="path of checkpoint")
    parser.add_argument('--image-dir', type=str, default=r'E:\VMATDATA\realhuman_reformat\pexels-artem-podrez-5457692\frames', help="input image dir")
    parser.add_argument('--mask-dir', type=str, default=r'E:\VMATDATA\realhuman_reformat\pexels-artem-podrez-5457692\masks', help="input mask dir")
    ...
    parser.add_argument('--output', type=str, default=r'E:\VMATDATA\realhuman_reformat\pexels-artem-podrez-5457692\mg-result', help="output dir")
