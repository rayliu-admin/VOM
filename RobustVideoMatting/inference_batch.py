...
if __name__ == '__main__':
    ...
    for dirnames in os.listdir(data_dir):
        ...
        frame_dir = os.path.join(data_dir,dirnames,'frames')
        if not os.path.exists(rvm_result_dir):
            os.makedirs(rvm_result_dir)
            print(f"Created 'rvm-result' directory in {data_dir,dirnames}")

        converter.convert(
            input_source=frame_dir,
            input_resize=args.input_resize,
            downsample_ratio=args.downsample_ratio,
            output_type=args.output_type,
            output_composition=args.output_composition,
            output_alpha= rvm_result_dir,
