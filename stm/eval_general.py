...
### My libs
from stm.dataset import DAVIS_MO_Test,CUSTOM_Dataset
...
def get_arguments():
    ...
    parser.add_argument("-exp", type=str, help="set",default='realmanv1')
    ...
    parser.add_argument("-ckpt", type=str, help="path to data",default='/home/liurui/Model/STM_weights.pth')
...
# palette = Image.open(os.path.join(DATA_ROOT , 'dove/Annotations/0.png')).getpalette()
...
Testset = CUSTOM_Dataset(DATA_ROOT,True)
...
code_name = '{}_DAVIS_{}'.format(MODEL,EXPNAME)
...
for seq, V in enumerate(Testloader):
    ...
    for f in range(num_frames):
        import cv2
        cv2.imwrite(os.path.join(test_path, '{:05d}.png'.format(f)),pred[f]*255)
