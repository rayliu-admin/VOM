...
from cutie.inference.data.vos_test_dataset import VOSTestDataset,VOSCustomDataset
...
@hydra.main(version_base='1.3.2', config_path='config', config_name='eval_config_self.yaml')
def eval_vos(cfg: DictConfig):
    ...
    if is_burst:
        ...
        meta_dataset = VOSCustomDataset(cfg.data_directory,
